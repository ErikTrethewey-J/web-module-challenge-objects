...
console.log(createMenuItem("Muffin", 6, "Breakfast"));

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */

console.log(createMenuItem("Muffin", 6, "Breakfast"));
console.log(createMenuItem("Taco's", 3, "Lunch"));
...
reviews.push({ name: "Erik", rating: 5, feedback: "This is a new Review." });
...
function getLastReview(rev) {
  ...
  }, and their feedback was: ${rev[rev.length - 1].feedback}`;
} //fucntion
